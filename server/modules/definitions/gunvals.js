module.exports = {
    // Bases
        ...
        swarm: { reload: 19, recoil: 0.25, shudder: 0.05, size: 0.4, damage: 0.75, speed: 4, spray: 5 },
    ...
    // Spammers
        ...
        spreadshotMain: { reload: 0.781, recoil: 0.25, shudder: 0.5, speed: 1.923, maxSpeed: 2.436 },
        spreadshot: { reload: 1.5, shudder: 0.25, speed: 0.7, maxSpeed: 0.7, spray: 0.25, recoil: 0.75 },
    ...
    // Snipers
        sniper: { reload: 1.35, shudder: 0.25, damage: 0.8, pen: 1.1, speed: 1.5, maxSpeed: 1.5, density: 1.5, spray: 0.2, resist: 1.3, },
        crossbow: { reload: 2, health: 0.9, damage: 0.9, pen: 0.8 },
        assassin: { reload: 1.65, shudder: 0.25, health: 1.35, damage: 1.2, pen: 1.6, speed: 1.18, maxSpeed: 1.18, density: 3, resist: 2 },
    ...
    // Flanks
        ...
        thruster: { recoil: 1.3, shudder: 2, health: 0.5, damage: 0.5, pen: 0.7, spray: 0.5, resist: 0.7 },
    ...
    // Drones
        ...
        baseProtector: { reload: 2, recoil: 0, health: 100, range: 0.5, density: 5, resist: 10, size: 2 },
        ...
        sunchip: { reload: 4, size: 1.4, health: 1.1, damage: 1, pen: 0.6, density: 0.8 },
        ...
        suborbit: { size: 1.2, damage: 0.65, health: 0.7 },
        negro: { damage: 0.375 },
    ...
    // Traps and blocks
        ...
        construct: { reload: 3, size: 0.9, maxSpeed: 1.1, damage: 1.6, health: 1.6, density: 2, resist: 5 },
