module.exports = {
    // Bases
        basic: { reload: 11, recoil: 0.75, shudder: 0.1, damage: 0.75, speed: 4.5, spray: 15 },
    ...
    // Spammers
        ...
        spreadshotMain: { reload: 0.5, recoil: 0.25, shudder: 0.5, health: 1, speed: 1.923, maxSpeed: 2.436 },
        spreadshot: { reload: 1.3, shudder: 0.25, speed: 0.7, maxSpeed: 0.7, spray: 0.25, recoil: 0.75 },
    ...
    // Drones
        ...
        bee: { reload: 1.3, size: 1.4, damage: 2, pen: 0.8, speed: 1.5, maxSpeed: 1.5, density: 0.25 },
        ...
        negro: { reload: 0.5 },
        swarmeer: { reload: 0.8 },
        babyDrone: { reload: 1.5, health: 0.6, damage: 0.7, speed: 0.9, maxSpeed: 0.9, size: 2 },
    ...
    // Traps and blocks
        ...
        construct: { reload: 3, size: 0.9, maxSpeed: 1.1, damage: 2, health: 2 },
