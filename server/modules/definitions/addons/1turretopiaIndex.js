...
const polyGuns = [
    ...
    },
    {
        ...
        PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.drone, g.sunchip, g.negro, {reload: 0.8}]),
            TYPE: "sunchippoly",
            AUTOFIRE: true,
            SYNCS_SKILLS: true,
    ...
    GUNS: [
            {
                ...
                PROPERTIES: {
                    SHOOT_SETTINGS: combineStats([g.swarm, g.bee, { speed: 0.75, size: 0.75 }, g.babyDrone]),
                    TYPE: ["bee", { INDEPENDENT: true }],
                    STAT_CALCULATOR: ["swarm", "fixedReload"],
                    SYNCS_SKILLS: true,
                    WAIT_TO_CYCLE: true,
    ...
    GUNS: [
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.minionGun, g.pounder, g.destroyer, { reload: 0.7, damage: 0.75, health: 0.75 }]),
                WAIT_TO_CYCLE: true,
                TYPE: "bullet",
            },
        },
...
Class.topBanana = {
    ...
    GUNS: [
        ...
        },
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.factory, { reload: 5, size: 1.1, health: 6, speed: 0.5, maxSpeed: 0.55 }]),
                TYPE: "megaMinion",
                MAX_CHILDREN: 1,
                STAT_CALCULATOR: "drone",
                AUTOFIRE: true,
...
Class.foundry = {
    ...
    GUNS: [
        ...
        },
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.factory, { reload: 3.5, size: 1.1, health: 2, speed: 0.65, maxSpeed: 0.7 }]),
                TYPE: "megaMinion",
                MAX_CHILDREN: 3,
                STAT_CALCULATOR: "drone",
                AUTOFIRE: true,
...
Class.enchanter = {
    ...
    GUNS: weaponArray({
        ...
        PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.drone, g.sunchip, g.negro, { reload: 1.35, health: 0.75, damage: 0.6 }]),
            TYPE: "trichip",
            AUTOFIRE: true,
            SYNCS_SKILLS: true,
            STAT_CALCULATOR: "necro",
...
Class.preacher = {
    ...
    GUNS: weaponArray({
        ...
        PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.drone, g.sunchip, g.negro, g.pounder, { reload: 1.5, size: 1.7, health: 0.86, damage: 0.6 }]),
            TYPE: "pentachip",
            AUTOFIRE: true,
            SYNCS_SKILLS: true,
            STAT_CALCULATOR: "necro",
...
Class.necroa = {
    ...
    GUNS: weaponArray({
        ...
        PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.drone, g.sunchip, g.negro, g.pounder, { reload: 2, size: 2, damage: 0.81, health: 0.81 }]),
            TYPE: "falsechip",
            AUTOFIRE: true,
            SYNCS_SKILLS: true,
            STAT_CALCULATOR: "necro",
...
Class.polymancer = {
    ...
    },
    {
        ...
        PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.drone, g.sunchip, g.negro, g.pounder, { reload: 2, size: 2 }]),
            TYPE: "hexachippoly",
            AUTOFIRE: true,
            SYNCS_SKILLS: true,
            STAT_CALCULATOR: "necro",
...
Class.cloner = {
    ...
    GUNS: [
        ...
        },
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.factory, { reload: 3, size: 1.2, health: 4, speed: 0.75, maxSpeed: 0.75 }]),
                TYPE: "kiloMinion",
                MAX_CHILDREN: 1,
                STAT_CALCULATOR: "drone",
                AUTOFIRE: true,
    ...
    GUNS: weaponArray(
        {
            POSITION: [7, 7.5, 0.7, 7, 0, 60, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.swarm, { damage: 2, health: 1.5, reload: 1.75 }]),
                TYPE: "swarm",
                STAT_CALCULATOR: "swarm",
                SYNCS_SKILLS: true,
                WAIT_TO_CYCLE: true
...
Class.seerTurret = makeTurret(
    ...
    }, { color: "mirror", independent: false, facingType: ["spin", { speed: 0.04 }], fov: 1.5  }
)
    ...
    GUNS: [
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.twin, g.triplet, { recoil: 0 }]),
                TYPE: "bullet",
            },
        }, {
            POSITION: [18, 10, 1, 0, -5.25, 0, 0.5],
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.twin, g.triplet, { size: 1.5, recoil: 0 }]),
                TYPE: "bullet",
            },
        }
    ],
...
Class.auraTankGenBig = addAura(2, 1.2)
Class.forgery = {
    PARENT: "tank",
    LABEL: "Forgery",
    TURRETS: [
...
Class.auraTankGenBigger = addAura(2.5, 1.35, 0.4, "darkGrey")
Class.lifebane = {
    PARENT: "tank",
    LABEL: "Lifebane",
    TURRETS: [
...
Class.auraTankGenBiggest = addAura(3, 1.5, 0.4, "lightGray")
Class.halberd = {
    PARENT: "tank",
    LABEL: "Halberd",
    TURRETS: [
...
Class.ethereal = {
    ...
    UPGRADE_TOOLTIP: "WARNING: Upgrade the body first, then the guns, otherwise you'll lose a lot of skill points!",
    LABEL: "Ethereal",
    EXTRA_SKILL: 6
}
Class.etherealBody = {
...
Class.spawner.UPGRADES_TIER_3.push("topBanana", "watchwoman", "cloner", "sqrtFactory", "inventor")
Class.underseer.UPGRADES_TIER_3.push("polyseer", "enchanter", "preacher", "necroa")
...
Class.trapper.UPGRADES_TIER_1 = ["builder", "triTrapper", "trapGuard"]
    ...
    Class.trapGuard.UPGRADES_TIER_2 = ["bushwhacker", "hijacker", "planetary", "bulwark", "overtrapper"]
    Class.builder.UPGRADES_TIER_2 = ["coop", "engineer", "boomer", "assembler", "architect", "planetary"]
...
Class.tank.UPGRADES_TIER_0 = ["auraTank", "smasherTank", "autoTank", "machine", "directTank"]
