    ...
    GUNS: [
            {
                ...
                PROPERTIES: {
                    SHOOT_SETTINGS: combineStats([g.swarm, g.bee, { speed: 0.75, size: 0.75, damage: 0.5 }, g.babyDrone]),
                    TYPE: ["bee", { INDEPENDENT: true }],
                    STAT_CALCULATOR: ["swarm", "fixedReload"],
                    SYNCS_SKILLS: true,
                    WAIT_TO_CYCLE: true,
    ...
    GUNS: [
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.minionGun, g.pounder, g.destroyer]),
                WAIT_TO_CYCLE: true,
                TYPE: "bullet",
            },
        },
...
Class.foundry = {
    ...
    GUNS: [
        ...
        },
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.factory, { reload: 3, size: 1.15, health: 2, speed: 0.7, maxSpeed: 0.7 }]),
                TYPE: "megaMinion",
                MAX_CHILDREN: 3,
                STAT_CALCULATOR: "drone",
                AUTOFIRE: true,
...
Class.sqrtFactory = {
    ...
    GUNS: [
        ...
        },
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.factory, { reload: 2 }]),
                TYPE: "squareMinion",
                MAX_CHILDREN: 4,
                STAT_CALCULATOR: "drone",
                AUTOFIRE: true,
    ...
    GUNS: [
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.minionGun, { damage: 0.4, pen: 0.8 }]),
                WAIT_TO_CYCLE: true,
                TYPE: "bullet",
            },
        },
...
Class.industry = {
    ...
    GUNS: weaponArray([
        ...
        },
        {
            ...
            PROPERTIES: {
                MAX_CHILDREN: 4,
                SHOOT_SETTINGS: combineStats([g.factory, g.babyfactory, { health: 0.2, damage: 0.2, pen: 0.5 }]),
                TYPE: "smallminion",
                STAT_CALCULATOR: "drone",
                AUTOFIRE: true,
                SYNCS_SKILLS: true,
...
Class.overpen = makeOver(Class.pen, "Over-Pen", {count: 1, independent: true})
Class.hexadecimator = {
    PARENT: "genericTank",
    LABEL: "Hexadecimator",
    STAT_NAMES: statnames.mixed,
...
Class.kraal = {
    ...
    GUNS: [
        ...
        },
        {
            POSITION: [2, 12, 1.1, 18, 0, 0, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.trap, g.setTrap, g.twin, g.doubleTwin]),
                TYPE: "setTrap",
                STAT_CALCULATOR: "block",
            },
        },
...
Class.cache = {
    ...
    GUNS: [
        ...
        },
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.trap, g.twin, g.triplet, g.doubleTwin]),
                TYPE: "trap",
                STAT_CALCULATOR: "trap",
            },
        },
...
Class.trapper.UPGRADES_TIER_1 = ["builder", "triTrapper", "trapGuard", "overtrapper", "barracuda"];
    ...
    Class.builder.UPGRADES_TIER_2 = ["coop", "engineer", "boomer", "assembler", "quadBuilder", "planetary"];
