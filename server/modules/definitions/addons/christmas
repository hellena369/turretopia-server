(function(c, s = Math.floor(Math.random() * 5) + 1, r = 1) {
    const t = [
        "bullet", ["bullet", { CONTROLLERS: ['snake'] }], "turretedBullet", "growBullet", "trap",
        "setTrap", "unsetTrap", "pillbox", "missile", "minimissile", "spinmissile", "drone", "swarm"
    ];
    ...
    console.log("[christmas.js] Christmas Mayhem with multiplier:", s);
})(Class);