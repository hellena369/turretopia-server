...
Class.mega3 = makeRadialAuto("megaAutoTankGun", {isTurret: true, danger: 7, size: 14, label: "Mega-3"})
Class.auto4 = makeRadialAuto("auto4gun", {isTurret: true, danger: 7, size: 13, x: 6, angle: 45, label: "Auto-4", count: 4})
Class.banshee = makeRadialAuto("bansheegun", {isTurret: true, danger: 7, size: 10, arc: 80, label: "Banshee", body: { FOV: 1.1 * base.FOV}})
...
Class.commander = {
    ...
    GUNS: [
        ...
        ...weaponArray({
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.swarm, g.commander, g.swarmeer]),
                TYPE: "swarm",
                STAT_CALCULATOR: "swarm",
            },
        }, 3, 1/3),
    ...
    GUNS: [
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.swarm, g.battleship, g.carrier, g.swarmeer]),
                TYPE: "swarm",
                STAT_CALCULATOR: "swarm",
            },
        },
    ...
    GUNS: [
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.swarm, g.battleship, g.swarmeer]),
                TYPE: "swarm",
                STAT_CALCULATOR: "swarm",
                LABEL: "Guided"
            }
    ...
    GUNS: [
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.drone, g.sunchip, g.maleficitor, g.negro]),
                TYPE: [
                    "sunchip",
                    {
                        INVISIBLE: [0.06, 0.03],
    ...
    GUNS: weaponArray([
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.drone, g.sunchip, g.negro, {reload: 0.5}]),
                TYPE: "eggchip",
                AUTOFIRE: true,
                SYNCS_SKILLS: true,
                STAT_CALCULATOR: "necro",
...
Class.architect = makeRadialAuto("architectGun", {isTurret: true, danger: 7, size: 12, label: "Architect", BODY: { HAS_NO_RECOIL: true }})
...
// Upgrade Paths
    ...
    Class.twin.UPGRADES_TIER_2 = ["doubleTwin", "tripleShot", "gunner", "hexaTank", "helix"]
        ...
        Class.doubleTwin.UPGRADES_TIER_3 = ["tripleTwin", "hewnDouble", "bentDouble"]
    ...
    Class.sniper.UPGRADES_TIER_2 = ["assassin", "hunter", "minigun", "rifle", "marksman"]
        ...
        Class.assassin.UPGRADES_TIER_3 = ["ranger", "falcon", "stalker", "single", "deadeye"]
    ...
    Class.machineGun.UPGRADES_TIER_2 = ["artillery", "minigun", "gunner", "sprayer"]
        ...
        Class.gunner.UPGRADES_TIER_3 = ["nailgun", "auto4", "machineGunner", "gunnerTrapper", "cyclone", "overgunner"]
    ...
    Class.flankGuard.UPGRADES_TIER_2 = ["hexaTank", "triAngle", "auto3", "trapGuard", "triTrapper"]
        ...
        Class.triAngle.UPGRADES_TIER_3 = ["fighter", "booster", "falcon", "hijacker", "surfer", "eagle", "phoenix", "vulture"]
        Class.auto3.UPGRADES_TIER_3 = ["auto5", "mega3", "auto4", "banshee"]

    Class.director.UPGRADES_TIER_1 = ["overseer", "cruiser", "underseer", "spawner"]
        Class.director.UPGRADES_TIER_3 = ["manager", "bigCheese"]
        Class.overseer.UPGRADES_TIER_3 = ["overlord", "overtrapper", "overgunner", "banshee", "overdrive", "commander"]
        Class.cruiser.UPGRADES_TIER_3 = ["carrier", "battleship", "fortress", "commander"]
    ...
    Class.desmos.UPGRADES_TIER_2 = ["helix", "sidewinder", "repeater"]
