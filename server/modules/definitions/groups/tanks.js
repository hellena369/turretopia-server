          ...
          if (dist2 <= ((body.size / 12) * 250) ** 1.9) {
            if (
              (instance.team != body.team ||
                (instance.type == "undertowEffect" &&
                  instance.master.id == body.master.id)) &&
              instance.type != "wall" &&
              instance.isTurret != true
            ) {
  ...
  GUNS: [
    {
      ...
      PROPERTIES: {
        ...
        TYPE: [
          ...
          {
            CONTROLLERS: [
              ["snake", { invert: true, amplitude: 180, yOffset: 50 }],
            ],
          },
        ],
      },
    ...
    },
    {
      ...
      PROPERTIES: {
        ...
        TYPE: [
          ...
          {
            CONTROLLERS: [
              ["snake", { invert: false, amplitude: 180, yOffset: -50 }],
            ],
          },
        ],
      },
  ...
  GUNS: [
    {
      ...
      PROPERTIES: {
        ...
        TYPE: [
          "splitterBullet",
          { CONTROLLERS: [["snake", { invert: false }]] },
        ],
      },
    },
    {
